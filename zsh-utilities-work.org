  ...
  function build_parfile()
  {
      ...
      if [[ ${likelihood:l} = hillipop ]]; then
          ...
          if [[ ${likelihood} = HiLLiPOP ]]; then
              section="Legacy" extract_params
          elif [[ ${likelihood} = Hillipop ]]; then
              section="source modeling" extract_params
          fi
      else
...
#+BEGIN_SRC sh
  ...
  function _build_parfile()
  {
      _arguments                                                                                  \
          ...
          {-d,--debug}'[debug mode]'                                                              \
          {-D,--devel}'[devel mode]'                                                              \
          '--output-file[set output parfile name]'                                                \
      ...
      case $state in
          engine)
              ...
              _values 'CMB engines' $_engines && ret=0
              ;;
          likelihood)
              _likes=(
                  "clik"
              ...
              _values 'CMB likelihoods' $_likes && ret=0
              ;;
          spectrum)
              _specs=(
                  "TT"
