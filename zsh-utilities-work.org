...
#+BEGIN_SRC sh
  function do_cmb_setup()
  {
      ...
      # MKL
      pkgtools__add_path_to_PATH /usr/local/intel/compilers_and_libraries_2017/linux/bin/intel64
      pkgtools__add_path_to_LD_LIBRARY_PATH /usr/local/intel/compilers_and_libraries_2017/linux/mkl/lib/intel64_lin
      ...
      # pkgtools__add_path_to_PATH ${PYTHONHOME}/bin

      # # PICO
      # # source ${CAMEL}/anaconda_setup.sh
      ...
      # pkgtools__reset_variable CMTCONFIG ${CMTBIN}
