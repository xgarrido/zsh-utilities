...
*** Working configuration                                        :obsolete:
  ...
  function mydpp_processing ()
  {
      ...
      if $(pkgtools__has_binary bxdpp_processing); then
          ...
          bxdpp_processing \
              ...
              --datatools::resource-path=falaise@$SNAILWARE_PRO_DIR/falaise/install/share/Falaise-2.0.0/resources \
...
#+BEGIN_SRC sh
  if (( $+functions[cm] )); then
      ...
      {
          cm $(pkgtools__get_binary_path bxocd_manual) $@
      }
  fi
#+END_SRC
** Lyon ccali aliases
