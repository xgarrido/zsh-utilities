  ...
  --mod::generate_makefile () {
      ...
      case $type in
          (talk)
              ...
              echo                                                                    >> ${make_file}
              echo "tarball : clean"                                                  >> ${make_file}
              echo "\t@mkdir -p tarball"                                              >> ${make_file}
              echo "\t@cd tarball && tar --exclude=\"../.git*\" --exclude=\"../tarball\" -czvf talk_{dirname}.tar.gz .">> ${make_file}
              echo                                                                    >> ${make_file}
              echo "clean:"                                                           >> ${make_file}
              echo "\t@rm -rf latex.d *.tex *.pdf *.fdb* *~ *.el tarball"             >> ${make_file}
