...
This is part of the [[file:zsh-utilities.org][Zsh Utilities Kit]].
...
#+BEGIN_SRC sh
  function __configure_laptop ()
  {
      ...
      pkgtools__set_variable TEXMFHOME ${HOME}/.config/texmf

      # Load Go Programming Language
      pkgtools__set_variable GOPATH ${HOME}/Development/go
      ...
      # Set HOST
      pkgtools__set_variable HOST ${HOSTNAME}
      pkgtools__set_variable WORKDIR ${HOME}/Workdir
...
#+BEGIN_SRC sh
  function __configure_lal_machines ()
  {
      ...
      umask 022
      pkgtools__set_variable WORKDIR /exp/nemo/garrido
      ...
      # Load Go Programming Language
      pkgtools__set_variable GOROOT ${WORKDIR}/software/go
      pkgtools__add_path_to_PATH ${WORKDIR}/software/go/bin
      pkgtools__set_variable GOPATH ${WORKDIR}/development/go
      pkgtools__add_path_to_PATH $GOPATH/bin
...
#+BEGIN_SRC sh
  function __configure_lyon_machines ()
  {
      ...
      pkgtools__set_variable SW_BASE_DIR ${GROUP_DIR}/sw2
      pkgtools__set_variable SCRATCH_DIR /sps/nemo/scratch/garrido
