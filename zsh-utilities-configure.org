...
#+BEGIN_SRC sh
  function __configure_lyon_machines ()
  {
      ...
      pkgtools__add_path_to_PATH /usr/local/cmake/3.2.2/bin
      pkgtools__add_path_to_PATH /usr/local/gcc/4.8.5/bin
      pkgtools__add_path_to_LD_LIBRARY_PATH /usr/local/gcc/4.8.5/lib64
