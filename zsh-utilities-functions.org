...
#+BEGIN_SRC sh
  ...
  k () {
      ...
      do
          ...
          # --- --- rwx warning
          if [[ $PER3 == "rwx" && ! IS_SYMLINK ]]; then PERMISSIONS_OUTPUT=$'\e[30;41m'"$PERMISSIONS"$'\e[0m'; fi
          ...
          if (( IS_GIT_REPO )) && (( k > 0 )) && [[ "$NAME" != '.git' ]] && (( !IS_DIRECTORY ))
          then
